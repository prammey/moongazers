        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-lg border border-gray-200 shadow-lg w-full max-w-4xl max-h-[85vh] overflow-hidden">
            ...
            <div className="p-6 overflow-auto max-h-[75vh]">
              <h2 className="text-xl font-bold mb-4 text-gray-900">MoonGazers Documentation</h2>
              <p className="text-gray-700">
                Complete documentation for the MoonGazers stargazing forecast application.
              </p>
            </div>
          </div>
        </div>
